    ...
    <div className="grid gap-3 sm:grid-cols-3">
      {FEATURE_COLUMNS.map((column, index) => {
        ...
        return (
          <div
            key={column.title}
            className="group/feature relative overflow-hidden rounded-2xl bg-background/55 p-5 shadow-[0_1px_0_0_color-mix(in_oklab,white_65%,transparent),0_14px_32px_-24px_rgba(27,30,36,0.4)] ring-1 ring-foreground/10 backdrop-blur-xl transition-[transform,background-color,box-shadow] duration-200 ease-out animate-stream-in hover:-translate-y-0.5 hover:bg-background/75 hover:shadow-[0_1px_0_0_color-mix(in_oklab,white_75%,transparent),0_22px_40px_-22px_rgba(27,30,36,0.45)] dark:bg-card/45 dark:shadow-[0_1px_0_0_color-mix(in_oklab,white_10%,transparent),0_18px_36px_-24px_rgba(0,0,0,0.7)] dark:ring-foreground/12 dark:hover:bg-card/60"
